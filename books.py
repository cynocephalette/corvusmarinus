books = [
  ...
  {
    "_id":52,
    "author_details":"Kramer, Heinrich|Sprenger, Jakob|Summers, Montague|Sprenger, James|Institoris, Heinrich",
  ...
  },
  {
    ...
    "loaned_to":"",
    "anthology_titles":"",
    "description":"Is it really possible to invent a machine that does the job of a writer? What is it about the landlady's house that makes it so hard for her guests to leave? Does Sir Basil Turton value most his wife or one of his priceless sculptures? These compelling tales are a perfect introduction to the adult writing of a storytelling genius.<br><br>",
